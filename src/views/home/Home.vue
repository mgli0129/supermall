    ...
    methods: {
      ...
      getMultiData() {
        this.$api.home.getHomeMultidata().then(res => {
          ...
          this.banners = res.data[this.$api.home.BANNER].list
          this.recommends = res.data[this.$api.home.RECOMMEND].list
      ...
      getHomeProducts(type) {
        this.$api.home.getHomeData(type, this.goodsList[type].page).then(res => {
          console.log(res);
